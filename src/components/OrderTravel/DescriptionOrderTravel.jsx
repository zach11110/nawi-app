      ...
      <main>
        <section className="flex flex-wrap justify-center max-w-7xl mx-auto py-6">
          {hotels.map((hotel) => (
            <div key={hotel.id} className="w-full sm:w-1/2 lg:w-1/2 p-2">
              <div className="w-full rounded-lg shadow-md overflow-hidden mb-4 sm:p-2 bg-white float-right">
                <div className="flex">
                  <img
        ...
        <section className="flex flex-wrap justify-center max-w-7xl mx-auto py-6">
          {resturants.map((resturant) => (
            <div key={resturant.id} className="w-full sm:w-1/2 lg:w-1/2 p-2">
...
export default DescriptionOrderTravel;
