...
const CardsVehicle = ({ title, isSpecial }) => {
  ...
  const vehicles = [
    {
      ...
      name: t('vehicle_name'),
      des1: "G63",
      des2: t('vehicle_engine'),
      des3: t('vehicle_horse'),
      image: Car,
      price: t('vehicle_price'),
      details: t('vehicle_details'),
      charies: t('vehicle_seater'),
      speed: t('vehicle_speed'),
      dezel: t('vehicle_dez'),
    },
    {
      id: 2,
      name: "لمبورغيني اوروس",
      des1: "G63",
      des2: "محركين",
        ...
        {currentItems.map((vehicle) => (
          ...
          >
            <div className="relative">
              <a href="#1" className="absolute top-2 right-2 z-10">
                <div className="w-[50px] h-[50px] bg-white shadow-lg rounded-full flex items-center justify-center">
                  <svg
                    width="21"
                    height="18"
                    viewBox="0 0 21 18"
              ...
              {isSpecial && (
                <div className="absolute top-2 left-2">
                  <button className="px-2 py-1 bg-[#9e2b9e] text-white rounded-lg font-medium text-sm flex items-center">
                    {t('vehicle_special')}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="#fff"
                    ...
                    >
                      <path d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456ZM16.894 20.567 16.5 21.75l-.394-1.183a2.25 2.25 0 0 0-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 0 0 1.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 0 0 1.423 1.423l1.183.394-1.183.394a2.25 2.25 0 0 0-1.423 1.423Z" />
                    </svg>
                  </button>
                </div>
              )}
            ...
            <div className="p-4">
              <div className="flex justify-between items-center mb-2">
                <span className="text-[#800080] font-bold text-lg">{vehicle.price}</span>
                <h5 className="text-xl font-bold text-right text-gray-900">{vehicle.name}</h5>
              </div>
              <p className="text-right text-gray-700">{vehicle.des1}</p>
              <p className="text-right text-gray-700">{vehicle.des2}</p>
              <p className="text-right text-gray-700 mb-3">{vehicle.des3}</p>
              <Link
                to="/details_cards_vehicle/"
                className="text-sm font-medium text-black hover:text-[#FFA500] block text-right"
              >
                {vehicle.details}
              </Link>
              <hr className="my-3" />
              <div className="flex justify-between items-center">
                <VehicleSpec icon="user" text={vehicle.charies} />
                <VehicleSpec icon="speed" text={vehicle.speed} />
                <VehicleSpec icon="fuel" text={vehicle.dezel} />
              </div>
            </div>
          </div>
        ))}
        ...
        <div className="text-center mt-8 pb-8">
          <Link to="/choose_categories/homepage_vehicles/all">
            <button
              ...
              className="px-8 py-3 bg-[#FFA500] text-white rounded-full hover:bg-[#800080] focus:outline-none font-bold text-lg transition duration-300"
            >
              {t('vehicle_more')}
            </button>
          </Link>
